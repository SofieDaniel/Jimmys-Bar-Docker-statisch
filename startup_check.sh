...
ueber_uns_test=$(curl -s https://aef4033e-b196-49c4-b0b0-48e6da1eef23.preview.emergentagent.com/api/cms/about 2>/dev/null || echo "ERROR")
...
delivery_test=$(curl -s https://aef4033e-b196-49c4-b0b0-48e6da1eef23.preview.emergentagent.com/api/delivery/info 2>/dev/null || echo "ERROR")
...
standorte_test=$(curl -s https://aef4033e-b196-49c4-b0b0-48e6da1eef23.preview.emergentagent.com/api/cms/standorte-enhanced 2>/dev/null || echo "ERROR")
...
kontakt_test=$(curl -s https://aef4033e-b196-49c4-b0b0-48e6da1eef23.preview.emergentagent.com/api/cms/kontakt-page 2>/dev/null || echo "ERROR")
