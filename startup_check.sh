...
ueber_uns_test=$(curl -s https://5a027dc8-43df-4ad8-b18c-0d49714d6dff.preview.emergentagent.com/api/cms/about 2>/dev/null || echo "ERROR")
...
delivery_test=$(curl -s https://5a027dc8-43df-4ad8-b18c-0d49714d6dff.preview.emergentagent.com/api/delivery/info 2>/dev/null || echo "ERROR")
...
standorte_test=$(curl -s https://5a027dc8-43df-4ad8-b18c-0d49714d6dff.preview.emergentagent.com/api/cms/standorte-enhanced 2>/dev/null || echo "ERROR")
...
kontakt_test=$(curl -s https://5a027dc8-43df-4ad8-b18c-0d49714d6dff.preview.emergentagent.com/api/cms/kontakt-page 2>/dev/null || echo "ERROR")
