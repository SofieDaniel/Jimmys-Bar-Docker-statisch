...
ueber_uns_test=$(curl -s https://ee9f4fdf-adb6-4e39-ace8-abca6abe3b17.preview.emergentagent.com/api/cms/about 2>/dev/null || echo "ERROR")
...
delivery_test=$(curl -s https://ee9f4fdf-adb6-4e39-ace8-abca6abe3b17.preview.emergentagent.com/api/delivery/info 2>/dev/null || echo "ERROR")
...
standorte_test=$(curl -s https://ee9f4fdf-adb6-4e39-ace8-abca6abe3b17.preview.emergentagent.com/api/cms/standorte-enhanced 2>/dev/null || echo "ERROR")
...
kontakt_test=$(curl -s https://ee9f4fdf-adb6-4e39-ace8-abca6abe3b17.preview.emergentagent.com/api/cms/kontakt-page 2>/dev/null || echo "ERROR")
